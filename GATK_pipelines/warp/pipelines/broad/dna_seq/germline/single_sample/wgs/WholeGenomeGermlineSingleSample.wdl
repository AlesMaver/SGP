...
import "../../../../../../../seq-format-conversion/bam-to-unmapped-bams.wdl" as BamToUbam
...
workflow WholeGenomeGermlineSingleSample {
  ...
  Array[File] sample_and_unmapped_bams.flowcell_unmapped_bams = BamToUnmappedBams.output_bam
